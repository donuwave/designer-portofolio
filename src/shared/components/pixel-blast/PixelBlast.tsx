...
const VIEWPORT_DOTS: ViewportDotConfig[] = [
  { id: 'top-left', top: VIEWPORT_DOT_OFFSET, left: VIEWPORT_DOT_OFFSET },
  {
    id: 'top-inner-left',
    top: VIEWPORT_DOT_OFFSET,
    left: VIEWPORT_DOT_INNER_X,
    translate: 'translateX(-50%)',
  },
  {
    id: 'top-inner-right',
    top: VIEWPORT_DOT_OFFSET,
    left: VIEWPORT_DOT_OUTER_X,
    translate: 'translateX(-50%)',
  },
  { id: 'top-right', top: VIEWPORT_DOT_OFFSET, right: VIEWPORT_DOT_OFFSET },
  {
    id: 'middle-left',
    top: VIEWPORT_DOT_CENTER_Y,
    left: VIEWPORT_DOT_OFFSET,
    translate: 'translateY(-50%)',
  },
  {
    id: 'middle-inner-left',
    top: VIEWPORT_DOT_CENTER_Y,
    left: VIEWPORT_DOT_INNER_X,
    translate: 'translate(-50%, -50%)',
  },
  {
    id: 'middle-inner-right',
    top: VIEWPORT_DOT_CENTER_Y,
    left: VIEWPORT_DOT_OUTER_X,
    translate: 'translate(-50%, -50%)',
  },
  {
    id: 'middle-right',
    top: VIEWPORT_DOT_CENTER_Y,
    right: VIEWPORT_DOT_OFFSET,
    translate: 'translateY(-50%)',
  },
  { id: 'bottom-left', bottom: VIEWPORT_DOT_OFFSET, left: VIEWPORT_DOT_OFFSET },
  {
    id: 'bottom-inner-left',
    bottom: VIEWPORT_DOT_OFFSET,
    left: VIEWPORT_DOT_INNER_X,
    translate: 'translateX(-50%)',
  },
  {
    id: 'bottom-inner-right',
    bottom: VIEWPORT_DOT_OFFSET,
    left: VIEWPORT_DOT_OUTER_X,
    translate: 'translateX(-50%)',
  },
  { id: 'bottom-right', bottom: VIEWPORT_DOT_OFFSET, right: VIEWPORT_DOT_OFFSET },
];
